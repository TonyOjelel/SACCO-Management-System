...
.blue-header {
    background-color: #007BFF; /* Change to the shade of blue you prefer */
...
<div class="container-fluid">
			...
			<div class="card dashboard">
				<div class="card-body">
						...
						<marquee behavior="alternate" style="color:green; font-weight: 400; font-size: 16px;" scrolldelay="300">At our SACCO, we believe in empowering dreams through secure savings and affordable loans, investing in your financial future, and fostering prosperity within the community. We offer personalized microfinance solutions, support local businesses, and make financial growth accessible for everyone. Join us to unlock your path to financial stability, success, and wealth-building, and become part of a thriving financial community dedicated to simplifying your journey to a brighter financial future.</marquee>
				</div>
            ...
            <table class="table table-bordered" id="loan-list">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo number_format($row['penalty_amount'],2) ?></td>
